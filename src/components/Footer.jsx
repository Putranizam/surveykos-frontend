...
export function Footer({ onOpenBooking, whatsappLink }) {
  return (
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-zinc-400">
            <li className="flex items-center gap-2">
              <Phone className="h-4 w-4" /> +62 812-1705-2097
            </li>
            <li className="flex items-center gap-2">
              <Mail className="h-4 w-4" /> nizamrasya07@gmail.com
            </li>
            <li className="flex items-center gap-2">
              <Camera className="h-4 w-4" /> @nizmmptra_
            </li>
            <li className="flex items-center gap-2">
